    ...
    <table>
      <tr title="Chapter in referenced book">
        ...
        <td><input type="text" id="chapter" name="chapter" size="20" maxlength="20" value="<?php echo $POST['chapter']?>" /></td>
      </tr>
      <tr title="Museum">
      ...
      <tr title="Museum number">
        ...
        <td><input type="text" id="museum_no" name="museum_no" size="40" maxlength="40" value="<?php echo $POST['museum_no']?>" /></td>
      </tr>
