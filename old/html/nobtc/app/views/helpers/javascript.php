...
class JavascriptHelper extends Helper{
	...
	var $_rules = array();
	/**
	 * Nastavi fokus na policko jehoz id mu predame.
	 */
	function focus($fieldId, $allowCache = true) {
		if (empty($fieldId)) {
		    return '';
		}
		$script = "var v = document.getElementById('$fieldId');\n" .
				  "v.focus();";
		return $this->codeBlock($script, $allowCache);
	}
/**
