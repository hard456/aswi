...
function update_word($czech,$english,$word_category,$verbal_class,
                     $present,$past,$valence,$root,$field,$word_id,$lection, $future, $infinitive, $gender, $vocalized, $nonvocalized,
  ...
  $dotaz = "UPDATE dict SET czech = '".AddSlashes($czech)."', 
                            ...
                            vocalized = '".AddSlashes($vocalized)."',
                            nonvocalized = '".AddSlashes($nonvocalized)."',
                            ...
                            word_category_foreign = '".AddSlashes($word_category_foreign)."', 
                            status_constructus_single = '".AddSlashes($status_constructus_single)."', 
                            status_constructus_plural = '".AddSlashes($status_constructus_plural)."', 
                            single_adj_female = '".AddSlashes($single_adj_female)."',
                            plural_adj_female = '".AddSlashes($plural_adj_female)."', 
                            conjugation = '".AddSlashes($conjugation)."', 
                            imperative = '".AddSlashes($imperative)."',
			    prefix = '".AddSlashes($prefix)."',
			    status_constructus_single_female = '".AddSlashes($status_constructus_single_female)."',
			    status_constructus_plural_female = '".AddSlashes($status_constructus_plural_female)."',
			    czech_female = '".AddSlashes($czech_female)."', 
			    single_female = '".AddSlashes($single_female)."', 
			    plural_female = '".AddSlashes($plural_female)."', 
                            status_constructus_single_noun_female = '".AddSlashes($status_constructus_single_noun_female)."', 
			    status_constructus_plural_noun_female = '".AddSlashes($status_constructus_plural_noun_female)."',
			    nonvocalized_female = '".AddSlashes($nonvocalized_female)."',
			    nonvocalized_alternative = '".AddSlashes($nonvocalized_alternative)."',
                            vocalized_alternative = '".AddSlashes($vocalized_alternative)."'
