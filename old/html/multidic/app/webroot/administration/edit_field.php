...
if (!Empty($action) && $action == "edit_field") {
  ...
  if (Empty($name)) {
    ...
    update_field($name, $en_field, $field_id);
...
<table>
    ...
    <form action="" method="POST" name="edit_field_form" onSubmit="return validate_edit_field_form(this)">
      ...
      <tr class="akt">
        ...
        <td><input type="text" name="en_field"  size="50" maxlength="50" value="<?php echo $en_field?>" /></td>
      </tr>
  ...
  <script language="javascript">
				<!--
					var focus = document.edit_field_form.name;
  				focus.focus();
				-->
  </script>
