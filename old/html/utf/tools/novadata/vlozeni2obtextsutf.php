...
<BODY>
<h1><center> Data insert into database table obtexts enc. UTF8</center></h1>
<br>
...
//tady webbookandchapter a webtransliteration if it is in old encoding keiln
				if (Pg_Exec ("INSERT INTO obtexts (bookandchapter, paragraph, transliteration, stransliteration, autor, date) VALUES ('($bookandchapter,', '$paragraph', '$transliteration', '$stransliteration', '$auth_userkod', '$date')"))
				{
					$heseldobre++;
				}
