...
<BODY>
<h1><center> Vkladani novych dat do cuneig - seznam tabulek pro grafemickou analyzu</center></h1>
<br><br>
	<form action="http://www.klinopis.cz/utf/tools/novadata/vlozeni2dictrefer.php" method="POST">
  	<fieldset>
    	<legend> <strong>Urceni souboru</strong></legend>
   			&nbsp;&nbsp;&nbsp;Datovy soubor v UTF-8: 
					&nbsp;&nbsp;&nbsp;<b>/webowner/data-in/<b><input type=text name=file1>
				<table border=0>
					<tr><td valign=top>
						&nbsp;&nbsp;Typ vkladanych dat:
					</td><td>
