...
<FONT FACE='Titus Cyberbit Basic' SIZE=3><BR>
<table border=1>
  <tr>
...
<?  
	$polozky="gnazev, bcislo, scteni, lcteni";
  $vysledek = Pg_Exec ($spojeni, "SELECT $polozky FROM graf01 ORDER BY gnazev;");
  $pocet = Pg_NumRows ($vysledek);

  for ($i=0; $i < $pocet; $i++)
  {
    list ($gnazev, $bcislo, $scteni, $lcteni) = Pg_Fetch_Array ($vysledek, $i);
    echo ("<tr><center><td>&nbsp; $gnazev </td>".
          "<td>&nbsp; $bcislo </td>".
          "<td>&nbsp; $scteni </td>".
          "<td>&nbsp; $lcteni </td>"."
