...
<table>
    ...
    <form action="" method="POST" name="edit_source_form" onSubmit="return validate_edit_source_form(this)">
      ...
      <tr class="akt">
        <td>titul*</td>
        <td><input type="text" name="title"  size="50" maxlength="100" value="<?echo($title)?>"/></td>
      </tr>
      <tr class="akt">
        <td>podtitul</td>
        <td><input type="text" name="subtitle"  size="50" maxlength="100" value="<?echo($subtitle)?>"/></td>
      </tr>
      <tr class="akt">
        <td>místo</td>
        <td><input type="text" name="place"  size="50" maxlength="100" value="<?echo($place)?>"/></td>
      </tr>
      <tr class="akt">
        <td>publikace</td>
        <td><input type="text" name="publication"  size="50" maxlength="100" value="<?echo($publication)?>"/></td>
      </tr>
      <tr class="akt">
        <td>publikační číslo</td>
        <td><input type="text" name="publication_no"  size="50" maxlength="30" value="<?echo($publication_no)?>"/></td>
      </tr>
      <tr class="akt">
        <td>od strany*</td>
        <td><input type="text" name="from_page"  size="50" maxlength="100" value="<?echo($from_page)?>"/></td>
      </tr>
      <tr class="akt">
        <td>do strany*</td>
        <td><input type="text" name="to_page"  size="50" maxlength="100" value="<?echo($to_page)?>"/></td>
      </tr>
      <tr class="akt">
        <td>jazyk</td>
      ...
      <tr class="akt">
        <td>rok</td>
        <td><input type="text" name="year"  size="50" maxlength="4" value="<?echo($year)?>"/></td>
      </tr>
