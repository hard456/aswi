...
// ulozeni udaju do DB
   $dotaz = "insert into book (autophoto, type, subject, title, subtitle, volume, number, volumesubnumber, place, year, publisher, isbn, issn, pageframe, signature, increasenumber1, increasenumber2, note, auth) 
             values ($id_autophoto, '$type', '$subject', '$title', '$subtitle', '$volume', '$number', '$volumesubnumber', '$place', '$year', '$publisher','$isbn','$issn','$pageframe', '$signature', $increasenumber1, $increasenumber2, '$note', 'hr01')";
