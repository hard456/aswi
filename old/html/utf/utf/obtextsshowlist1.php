...
<?
  ...
  $pod .= "stransliteration like '%$popis2%' AND public ='y'";

  $dotaz = "SELECT bookandchapter, paragraph, transliteration, public FROM obtexts left join obtextp on (obtexts.bookandchapter = obtextp.bookandchapterp) WHERE $pod";
//  echo $dotaz;
