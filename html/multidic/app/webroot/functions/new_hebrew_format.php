...
function __get_word_in_new_hebrew_format($Record)
{
...
<?php if("שם עצם"  === $word_category_foreign): ?>
  ...
  <?php if(!empty($Record['gender'])): ?>
	<p dir="rtl">
	<span class="arabic b" dir="rtl"><?php echo $Record['nonvocalized']?></span>
	<span class="arabic xs">‫ש"ע‬</span>
	<span class="arabic s" dir="ltr" style="direction:ltr"><?php echo $Record['gender']?></span>
	<span class="arabic b" dir="rtl"><?php echo $Record['past']?></span>
	</p>
...
<?php elseif( "מילת שאלה"  === $word_category_foreign): ?>
    <p dir="rtl">
    <span class="arabic b" dir="rtl"><?php echo $Record['nonvocalized']?></span>
    <span class="arabic xs" dir="ltr">  מילת שאלה  </span>
    <span class="arabic b" dir="rtl"><?php echo $Record['past']?></span>
    </p>
...
} //end of function __get_word_in_new_hebrew_format
