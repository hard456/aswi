 ...
 * @access public
 */
	var $ajaxDivUpdate = "body"; //content   container
/**
 ...
 * @access public
 */
	var $ajaxFormId = 'FilterFormId';//NULL    FilterFormId
/**
 * Specify link style
 *
 ...
 */
	...
	/**
	 * Pripravi pole criterii vyberu.
	 * prevezme z controler->data a je-li neco prazdne, vyrazi tuto podminku
	 *
	 */
	function getCriteria() {
		$ret = $this->controller->data['Filtr'];
		if (empty($ret)) {
		    return null;
		}
