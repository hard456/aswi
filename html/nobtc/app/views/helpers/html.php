 ...
 */
	function yearOptionTag($tagName, $value = null, $minYear = null, $maxYear = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true) {
		...
		$currentYear = date('Y');
		$maxYear = is_null($maxYear) ? $currentYear + 15 : $maxYear + 1;
		$minYear = is_null($minYear) ? $currentYear - 5 : $minYear;
 ...
 */
	function monthOptionTag($tagName, $value = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true) {
		...
		$months = array('01' => 'Leden', '02' => 'Únor', '03' => 'Březen', '04' => 'Duben', '05' => 'Květen', '06' => 'Červen', '07' => 'Červenec', '08' => 'Srpen', '09' => 'Září', '10' => 'Říjen', '11' => 'Listopad', '12' => 'Prosinec');
 ...
 */
	function tagValue($fieldName, $escape = false) {
		$this->setFormTag($fieldName);
		//var_dump($this->data[$this->model][$this->field]);
 ...
 */
	...
	function submit2($caption, $htmlAttributes = array(), $return = false) {
		$htmlAttributes['name'] = 'norepeat';
		$htmlAttributes['class'] = 'left';
		$ret = $this->submit($caption, $htmlAttributes, $return). "<br />";
		$htmlAttributes['name'] = 'repeatOnceAgain';
		$htmlAttributes['class'] = 'right';
		$caption = "Přidej a znovu vkládat";
		$ret .= $this->submit($caption, $htmlAttributes, $return);
		return $ret;
	}
}
?>
