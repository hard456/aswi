...
<table>
  <tr>
    <td>Book abbrev.</td>
    <td><?php echo get_is_or_isnot('id_book')?></td>
    <td>
        <?php chooser_get_book(); ?>
    </td>
  </tr>
  <tr>
    <td>Book name</td>
    <td>
        <?php echo  get_contain_chooser('book_name');?>
    </td>
    <td>
  ...
  <tr>
    <td>Type</td>
    <td><?php echo get_is_or_isnot('id_book_type')?></td>
    <td>
      <?php chooser_get_book_type(); ?>
    </td>
  </tr>
  <tr>
    <td>Author</td>
    <td>
        <?php echo  get_contain_chooser('book_autor');?>
    </td>
    <td>
  ...
  <tr>
    <td>Book chapter</td>
    <td>
        <?php echo  get_contain_chooser('chapter');?>
    </td>
    <td>
  ...
  <!--tr>
    ...
    <td>
        <?php echo  get_contain_chooser('alternate-pub');?>
    </td>
    <td>
  ...
  <tr>
    <td>Museum</td>
    <td><?php echo get_is_or_isnot('id_museum')?></td>
    <td>
        <?php chooser_get_museum(); ?>
    </td>
  </tr>
  <tr>
    <td>Museum number</td>
    <td>
        <?php echo  get_contain_chooser('museum_no');?>
    </td>
    <td>
  ...
  <tr>
    <td>Origin</td>
    <td><?php echo get_is_or_isnot('id_origin')?></td>
    <td>
      <?php chooser_get_origin(); ?>
    </td>
  </tr>
  <tr>
