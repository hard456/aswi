<?php
  ...
  $source   = 5;
  $lection  = 9;
  $cesta_ke_zvukum = "./voices/novy_adresar_pro_zvuky/Kont_9_lekce/";
...
*/
    ...
    while ($spojeni->next_record()) {
      ...
      $cil = "./voices/context/".$spojeni->Record["IDdict"].".mp3";
      if (File_Exists($cil)) {
      	echo "Chyba $cil jiz existuje.\n";
      	continue;
      }
      rename($zdroj, $cil);
      ...
      $dotaz_up = "UPDATE dict SET context_voice = 1 
