...
<table>
    ...
    <form action="" method="POST" name="edit_user_form" onSubmit="return validate_edit_user_form(this)">
      ...
      <tr class="akt">
        <td>Pozn.:&nbsp;</td>
        <td> Pokud nechcete <b>měnit</b> heslo, nechte následující kolonky <b>nevyplněné!!!</b></td>
      </tr>
      <tr class="akt">
        <td>nové heslo</td>
      ...
      <tr class="akt">
        <td>nové heslo pro potvrzení</td>
        <td><input type="password" name="password2"  size="50" maxlength="30" /></td>
      </tr>
      <tr>
        <td>
